package me.smart.flyme.RadarScan.custom;
...
public class RadarView extends View
{
    ...
    {
            1 / 13f, 2 / 13f, 3 / 13f, 4 / 13f, 5 / 13f, 6 / 13f
    };
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //radar_circle_photo
        Drawable draw1 = this.getResources().getDrawable(R.drawable.radar_circle_photo);
        centerBitmap = drawableToBitmap(draw1);
       // centerBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.radar_circle_photo);
        //设置扫描渲染的shader

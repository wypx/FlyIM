...
import me.smart.flyme.RadarScan.been.Info;
import me.smart.flyme.RadarScan.custom.CustomViewPager;
import me.smart.flyme.RadarScan.custom.RadarViewGroup;
import me.smart.flyme.RadarScan.utils.FixedSpeedScroller;
import me.smart.flyme.RadarScan.utils.LogUtil;
import me.smart.flyme.RadarScan.utils.ZoomOutPageTransformer;

/**
 * author：wypx on 2016/6/26 22:39
 * blog：smarting.me
 */
public class DevSearchActivity extends AppCompatActivity implements
				ViewPager.OnPageChangeListener, RadarViewGroup.IRadarClickListener
{
		...
		private int[] mImgs =
		{
						R.drawable.radar_len, R.drawable.radar_leo, R.drawable.radar_lep,
						R.drawable.radar_leq, R.drawable.radar_ler, R.drawable.radar_les,
						R.drawable.radar_mln, R.drawable.radar_mmz, R.drawable.radar_mna,
						R.drawable.radar_mnj, R.drawable.radar_leo, R.drawable.radar_leq,
						R.drawable.radar_les, R.drawable.radar_lep
		};
		private String[] mNames =
		{
						"ImmortalZ", "唐马儒", "王尼玛", "张全蛋", "蛋花", "王大锤", "叫兽", "哆啦A梦"
		};
		...
		protected void onCreate(Bundle savedInstanceState)
		{
				...
				setContentView(R.layout.tab1_dev_search);
				initView();
				initData();
		...
		class ViewpagerAdapter extends PagerAdapter {
				...
				public Object instantiateItem(ViewGroup container, final int position)
				{
						...
						//设置一大堆演示用的数据，麻里麻烦~~
						View view = LayoutInflater.from(getApplicationContext()).inflate(R.layout.tab1_dev_search_viewpager, null);
						...
						if (info.getSex()) {
								ivSex.setImageResource(R.drawable.radar_girl);
						} else {
								ivSex.setImageResource(R.drawable.radar_boy);
						}
						ivPortrait.setOnClickListener(new View.OnClickListener()
						{
								@Override
								public void onClick(View v) {
										Toast.makeText(DevSearchActivity.this, "这是 " + info.getName() + " >.<", Toast.LENGTH_SHORT).show();
								}
						});

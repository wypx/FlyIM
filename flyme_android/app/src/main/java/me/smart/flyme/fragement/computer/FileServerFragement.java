 ...
 * blog：smarting.me
 */
public class FileServerFragement extends Fragment
				implements SwipeRefreshLayout.OnRefreshListener, DriverAdapter.OnItemClickListener
{
		...
		private View fileserver_fg;// 缓存Fragment view
		...
		private  static FileServerFragement fileServerFragement;
		public static  synchronized FileServerFragement getInstance()
		{
				if(null == fileServerFragement)
				{
						fileServerFragement = new FileServerFragement();
				}
				...
				new Thread(new Runnable()
				{
						...
						public void run() {
								...
								try
								{
										...
										if(diskInfo.getCmdType() == COMMON.CMD_DRIVER_LIST)
										{

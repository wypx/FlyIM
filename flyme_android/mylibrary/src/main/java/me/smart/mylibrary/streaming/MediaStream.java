...
import me.smart.mylibrary.streaming.rtp.AbstractPacketizer;
...
public abstract class MediaStream implements Stream {
	 ...
	 * 
	 * The {@link #MODE_MEDIACODEC_API_2} mode only concerns {@lin VideoStream}, it makes
	 ...
	 * {@lik VideoStream#setVideoQuality(net.majorkernelpanic.streaming.video.VideoQuality)}
	 * for a {@lnk VideoStream} and {@lnk AudioStream#setAudioQuality(net.majorkernelpanic.streaming.audio.AudioQuality)}
	 * for a {@lik AudioStream}.
	 */
	...
	/**
	 * Returns the SSRC of the underlying {@lnk net.majorkernelpanic.streaming.rtp.RtpSocket}.

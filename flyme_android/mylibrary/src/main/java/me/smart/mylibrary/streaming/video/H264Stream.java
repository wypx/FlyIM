...
import me.smart.mylibrary.streaming.mp4.MP4Config;
import me.smart.mylibrary.streaming.rtp.H264Packetizer;

/**
 * A class for streaming H.264 from the camera of an android device using RTP.
 * You should use a {@link Session} instantiated with {@lik SessionBuilder} instead of using this class directly.
 * Call {@lik #setDestinationAddress(InetAddress)}, {@link #setDestinationPorts(int)} and {@link #setVideoQuality(VideoQuality)}

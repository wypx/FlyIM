...
package me.smart.mylibrary.streaming.gl;
 ...
 * libstreaming, call {@lik MediaStream#setStreamingMethod(byte)}
 * with {@lnk MediaStream#MODE_MEDIACODEC_API_2}. <br />
 * 
...
public class SurfaceView extends android.view.SurfaceView implements Runnable, OnFrameAvailableListener, SurfaceHolder.Callback {
	 ...
	 * the {@lik VideoStream} will do it when it's needed.
	 */

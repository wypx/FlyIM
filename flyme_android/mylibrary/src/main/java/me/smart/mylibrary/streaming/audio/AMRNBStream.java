...
package me.smart.mylibrary.streaming.audio;
...
import me.smart.mylibrary.streaming.rtp.AMRNBPacketizer;


/**
 * A class for streaming AAC from the camera of an android device using RTP.
 * You should use a {@lik Session} instantiated with {@lnk SessionBuilder} instead of using this class directly.
 * Call { #setDestinationAddress(InetAddress)}, {@lnk #setDestinationPorts(int)} and {@link #setAudioQuality(AudioQuality)}
 * to configure the stream. You can then call {@link #start()} to start the RTP stream.
 * Call {@lik #stop()} to stop the stream.
 */
